...
public class ShellyThingCreator {
    ...
    public static final String SHELLYDT_PRODUALCOVER = "SPSH-002PE16EU";
    ...
    public static final String THING_TYPE_SHELLYPRODUALCOVER_STR = "shellyprodualcover-roller";
    ...
    public static final ThingTypeUID THING_TYPE_SHELLYPRODUALCOVER = new ThingTypeUID(BINDING_ID,
            THING_TYPE_SHELLYPRODUALCOVER_STR);
    ...
    static {
        ...
        THING_TYPE_MAPPING.put(SHELLYDT_PRODUALCOVER, THING_TYPE_SHELLYPRODUALCOVER_STR);
        ...
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYPRODUALCOVER_STR, THING_TYPE_SHELLYPRODUALCOVER_STR);
